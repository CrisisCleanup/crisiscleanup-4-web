...
const plus = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="30" y="30">
        ...
        <g fill="none" fill-rule="evenodd">
            <g transform="translate(4 2)">
                ...
                <rect width="15.5" height="15.5" x=".25" y=".25" fill="#FFF" stroke="#2D2D2D" stroke-linejoin="square" stroke-width="{{strokeWidth}}" rx="2"/>
...
const animal_services = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="60" height="58" viewBox="0 0 60 58">
    ...
    <g transform="translate(4, 29) scale(0.9)">
        {{camera}}
    </g>
</svg>`;
...
const construction_consultation = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="49" height="53" viewBox="0 0 49 53">
                                    ...
                                    <g fill="none" fill-rule="evenodd" transform="translate(-57 -44)">
                                        <use fill="#000" filter="url(#a)" xlink:href="#b"/>
                                        <path fill="{{fillColor}}" stroke="{{strokeColor}}" stroke-linejoin="square" stroke-width="{{strokeWidth}}" d="M86.29 74.54c-1.558.61-2.99.915-4.298.915-1.306 0-2.732-.287-4.278-.858v2.391l-.206.037c-8.006 1.427-12.837 3.367-14.474 5.775-1.612 2.372-2.132 5.017-1.559 7.95h40.056c.582-3.372.005-6.105-1.726-8.218-1.772-2.163-6.219-4.15-13.325-5.932l-.19-.047V74.54zm4.691-14.19H72.984v4.611a8.75 8.75 0 0 0 8.75 8.75h.497a8.75 8.75 0 0 0 8.75-8.75v-4.61zm-8.334-14.1h-1.503a.75.75 0 0 0-.75.75v8.43h-9.926a.75.75 0 0 0-.75.75v1.54c0 .413.336.75.75.75h22.855a.75.75 0 0 0 .75-.75v-1.54a.75.75 0 0 0-.75-.75h-9.926V47a.75.75 0 0 0-.75-.75zm-4.035.94c-1.619.474-3.037 1.348-4.257 2.628-1.203 1.262-2.013 2.527-2.432 3.796h6.69V47.19zm6.567.004v6.42l6.683-.001c-.345-1.265-1.15-2.528-2.42-3.79-1.288-1.28-2.708-2.154-4.263-2.629z"/>
...
const fence = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="53" height="53" viewBox="0 0 53 53">
    ...
    <g transform="translate(2, 30) scale(0.9)">
        {{camera}}
    </g>
</svg>`;
...
const heating = `<svg width="55" height="58" viewBox="0 0 35 38" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(-1, 22) scale(0.65)">
        {{camera}}
    </g>
</svg>
`;
...
{{multiple}}
<g transform="translate(0, 29) scale(0.9)">
  {{camera}}
</g>
</svg>`;
...
const prescription = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="33" height="56" viewBox="0 0 33 56">
    ...
    <g fill="none" fill-rule="evenodd" transform="translate(-11 -1)">
        ...
        <path fill="{{fillColor}}" stroke="{{strokeColor}}"  stroke-linejoin="square" stroke-width="{{strokeWidth}}" d="M37.089 14.92H18.067v6.736h12.497v21.351H18.067l.005 5.162c.044.72.365 1.367.859 1.832.492.464 1.156.749 1.886.749l13.69-.005c.722-.044 1.368-.365 1.833-.859.464-.492.749-1.156.749-1.886V14.92zm-8.144 8.345H18.076l-.031 18.009h10.9V23.265zM39 6.685l-23.101.007c-.182.024-.343.114-.46.245-.117.132-.189.307-.189.498l.007 5.094c.024.182.114.343.245.46.132.117.307.189.498.189l23.101-.007c.182-.024.343-.114.46-.245.117-.132.189-.307.189-.498l-.007-5.094c-.024-.182-.114-.343-.245-.46-.132-.118-.307-.19-.498-.19zM36.339 3.25H18.66c-.207 0-.394.084-.53.22-.136.135-.22.323-.22.53v1.124H37.09V4c0-.207-.084-.395-.22-.53-.136-.136-.323-.22-.53-.22z"/>
    ...
    <g transform="translate(-4, 31) scale(0.9)">
        {{camera}}
    </g>
</svg>`;
...
const reject = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="52" height="52" viewBox="0 0 52 52">
    ...
    <g fill="none" fill-rule="evenodd" transform="translate(-717 -238)">
        <use fill="#000" filter="url(#a)" xlink:href="#b"/>
        <path fill="{{fillColor}}" stroke="{{strokeColor}}" stroke-linejoin="square" stroke-width="{{strokeWidth}}" d="M743 240.25c-12.012 0-21.75 9.738-21.75 21.75s9.738 21.75 21.75 21.75 21.75-9.738 21.75-21.75-9.738-21.75-21.75-21.75zm0 18.568l6.917-6.917.136-.124a2.25 2.25 0 0 1 3.163 3.178l-.124.135-6.91 6.91 6.91 6.91a2.25 2.25 0 0 1-3.047 3.306l-.135-.124-6.91-6.91-6.917 6.917-.136.124a2.25 2.25 0 0 1-3.163-3.178l.124-.135 6.91-6.91-6.91-6.91a2.25 2.25 0 0 1 3.04-3.313l.007.007.135.124 6.91 6.91z"/>
...
const tarp = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="58" height="58" viewBox="0 0 58 58">
    ...
    <g transform="translate(0, 35) scale(0.9)">
        {{camera}}
    </g>
</svg>`;
...
const trees = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="54" height="48" viewBox="0 0 54 48">
    ...
    <g fill="none" fill-rule="evenodd" transform="translate(-376 -240)">
        <use fill="#000" filter="url(#a)" xlink:href="#b"/>
        <path fill="{{fillColor}}" stroke="{{strokeColor}}" stroke-linejoin="square" stroke-width="{{strokeWidth}}" d="M403 242.361l-13.202 13.787 7.132-.001-11.751 12.48 7.756-.001-12.356 13.123 44.836.001-12.566-13.123h7.965l-11.949-12.479h7.337L403 242.361z"/>
...
const sandbagging = `<svg width="54" height="31" viewBox="0 0 54 31" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(0, 22) scale(0.9)">
        {{camera}}
    </g>
</svg>`;
...
>
  <path
    d="M20 5h-3.17l-1.2-1.6A1 1 0 0 0 14.96 3H9.04a1 1 0 0 0-.67.4L7.17 5H4C2.9 5 2 5.9 2 7v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm-8 12c-2.21 0-4-1.79-4-4
             0-2.21 1.79-4 4-4
             2.21 0 4 1.79 4 4
             0 2.21-1.79 4-4 4z"
    fill="#FFFFFF"
...
const renderAll = (fillColor: string, strokeColor: string) => {
  const icons = Object.keys(templates);
  const iconsHtml = icons.map((icon) => {
    const template = templates[icon];
    return template
      .replaceAll('{{fillColor}}', fillColor)
      .replaceAll('{{strokeColor}}', strokeColor)
      .replaceAll('{{multiple}}', plus)
      .replaceAll('{{camera}}', camera);
  });

  // render name under each
  for (const [index, icon] of iconsHtml.entries()) {
    iconsHtml[index] =
      icon +
      `<text x="0" y="40" font-size="12" fill="black">${icons[index]}</text>`;
  }

  return iconsHtml.join('\n');
};

export { templates, colors, renderAll };
